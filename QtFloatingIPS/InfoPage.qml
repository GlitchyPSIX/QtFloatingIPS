...
Item {
    ...
    <p>Alcaro\'s repo can be found here: <br><a href="https://github.com/Alcaro/Flips">https://github.com/Alcaro/Flips</a></p>

    <p>The qt5 GUI wrapper is written by me, <a href="https://github.com/covarianttensor">covarianttensor</a>, on Github.</p>

    <p>My repo can be found here: <br><a href="https://github.com/covarianttensor/QtFloatingIPS">https://github.com/covarianttensor/QtFloatingIPS</a></p>

    <p>This software is licensed under the GPL3.0. License text can be found <a href="https://raw.githubusercontent.com/Alcaro/Flips/master/COPYING.gpl3">here</a>.</p>
